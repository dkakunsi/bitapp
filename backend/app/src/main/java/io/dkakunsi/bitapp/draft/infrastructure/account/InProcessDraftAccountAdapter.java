package io.dkakunsi.bitapp.draft.infrastructure.account;
...
public class InProcessDraftAccountAdapter implements AccountPort {

  private final AccountRepository accountRepository;

  private final CreateAccount createAccountUseCase;

  public InProcessDraftAccountAdapter(AccountRepository accountRepository, CreateAccount createAccountUseCase) {
